const recipes = { 
    'mysore-masala-dosa': { 
      ...
      image:"images/mysore_masala_dosa.jpg", 
      ingredients: [ 
        '2 cups dosa batter', 
   ...
   method: 'Blend soaked rice with water. Spread thinly on a hot pan and cook. Serve with chutney.' }, 
    'mangalore-buns': { 
      ...
      method: 'Mash bananas and mix with yogurt, sugar, and salt. Add flour and baking soda. Roll into puris and deep fry 
  until golden.' 
    }, 
    'bisi-bele-bath': { 
      name: 'Bisi Bele Bath', 
    ...
    image: 'images/bisi_bele_bath.jpg', 
      ...
      method: 'Cook rice and dal. Boil vegetables. Mix tamarind, spices, and jaggery. Combine with rice and dal. Temper 
  and serve.' }, 
  'maddur-vada': { 
      name: 'Maddur Vada', 
    ...
    'udupi-sambar': { 
      ...
      method: 'Cook dal and vegetables. Mix with tamarind and spices. Simmer until thick. Garnish with coriander and 
  serve.' 
    }, 
    'chitranna': { 
      name: 'Chitranna', 
